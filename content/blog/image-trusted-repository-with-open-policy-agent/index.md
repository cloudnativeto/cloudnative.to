...
Rego 是一种高级的声明性语言，是专门为 OPA 建立的。更多 OPA 的介绍可以看 [Open Policy Agent 官网](https://www.openpolicyagent.org/)，不想看英文直接看[这里](https://cloudnative.jimmysong.io/blog/introducing-policy-as-code-the-open-policy-agent-opa/)。
