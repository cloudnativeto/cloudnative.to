...
draft: false
image: "/images/blog/kubernetes-autoscaling.jpg"
...
description: "本文介绍了kubernetes 的几种缩放方式: HPA、VPA、cluster scaler，并提供了两个测试用例以供测试和学习。"
...
查看原文：<https://caylent.com/kubernetes-autoscaling>。
